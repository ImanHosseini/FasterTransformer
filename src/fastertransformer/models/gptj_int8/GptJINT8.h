...
template<typename T>
class GptJINT8: public BaseLayer {
private:
    // meta data
    size_t     head_num_;
    ...
    GptJDecoderINT8<T>*            gpt_decoder_;
    GptJContextDecoderINT8<T>*     gpt_context_decoder_;
...
public:
    GptJINT8(size_t                              max_batch_size,
             size_t                              max_seq_len,
    ...
    GptJINT8(GptJINT8<T> const& GptJINT8);
