...
template<typename T>
class GptJContextDecoderINT8: public BaseLayer {
private:
    // buffer handling
...
public:
    GptJContextDecoderINT8(size_t                              max_batch_size,
                           size_t                              max_seq_len,
                           size_t                              head_num,
    ...
    GptJContextDecoderINT8(GptJContextDecoderINT8<T> const& decoder);

    ~GptJContextDecoderINT8();

    void forward(std::vector<Tensor>*                          output_tensors,
                 const std::vector<Tensor>*                    input_tensors,
                 const std::vector<GptJDecoderLayerWeightINT8<T>>* decoder_layer_weights);
